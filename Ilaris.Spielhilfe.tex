\documentclass[linksbund,ATvorVT]{rpg-ilaris}
\title{Ilaris.tex Vorlage}
\subtitle{entworfen von}
\author{Jan Battenfeld}
% Nächste Zeile auskommentieren, um im aktuellen Ordner nach den Schriften zu suchen - Für Online-LaTeX-Editoren aktivieren
% \defaultfontfeatures{Path="./", Ligatures=TeX} 
...
\alphagraphics[width=0.965\linewidth]{einleitung.jpg} % Bild mit transparentem Weiß einfügen [width=...] ist hierbei optional und defaultet zu 1\linewidth

\begin{multicols}{2}[        % Kapitelüberschrift, die über mehrere Spalten geht
		\chapter*{Beispiele}  % Die multicols-Umgebung sollte spätestens beim nächsten 
...
\end{multicols}
\begin{multicols}{2}[
		\chapter*{} % Trennbalken TODO
	]


\begin{gegner}{Bär}{Raubtier der Wälder, großer Gegner}{würfel20}%
	{\WsMrGsIni{11/13, Koloss I}{6}{6}{2}}
	{}% Vorteile
	% Waffen
	\waffe{Prankenhieb}{1}{6}{13}{2W6+6}{Niederwerfen (–4), Doppelangriff}
	\waffe{Biss       }{0}{13}{14}{4W6}{Feueratem (Wer zum Ziel eines Angriffs wird, muss eine Zähigkeits-Probe (16) ablegen, um nicht 1 Punkt  Erschöpfung zu erleiden.}
...
\begin{gegner}{Bär}{Raubtier der Wälder, großer Gegner}{}%
	...
	% Waffen
	\waffe{Prankenhieb}{1}{6}{13}{2W6+6}{Niederwerfen (–4), Doppelangriff}
	\waffe{Biss       }{0}{13}{14}{4W6}{Zerbrechlich}
...
\begin{gegner}{Blutfischschwarm}{gierige Fressmaschinen der Dschungelflüsse; großer Gegner}{}
	{\WsMrGsIni{3, Koloss II}{2 (einzelner Fisch)}{3, schwimmend}{1} }
	{Wasserwesen, Schmerzimmun II, Resistenz II (Stichwaffen), Verwundbarkeit IV (Flächenschaden)}
	\waffe{Biss}{0}{4}{14}{2W6+3}{}
	\textbf{Kampfvorteile:} Zusätzliche Attacke II
\trennlinie
...
\begin{gegner}{Name}{Fluff <groß>}{tier}
	{\WsMrGsIni{WS, <Koloss>}{MR}{GS}{INI}}
	{}% Vorteile (leerlassen, optional)
	\waffe{Waffe1}{RW}{AT}{VT}{Trefferpunkte}{Auto-Manöver (optional)}
	\waffe{Waffe2}{RW}{AT}{VT}{Trefferpunkte}{} % ohne Auto-Manöver leerlassen
...
\begin{gegner}{Blutfischschwarm}{gierige Fressmaschinen der Dschungelflüsse; großer Gegner}{}
	...
	\waffe{Bissattackencombo}{0}{4}{14}{2W6+3}{}
	\waffe{Biss}{0}{4}{14}{2W6+9000}{}
	\textbf{Kampfvorteile:} Zusätzliche Attacke II
